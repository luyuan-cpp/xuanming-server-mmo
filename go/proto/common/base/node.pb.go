...
const (
	...
	ENodeType_BattleNodeService          ENodeType = 28 // 回合制战斗节点(gRPC,全局池,不分 zone)
	ENodeType_ClientRpcRouterNodeService ENodeType = 29 // 客户端 RPC 路由服(Go-Zero,全局池):gate 唯一的 gRPC 目标,按 message_id 不透明转发到各业务 Go 服务(docs/design/client-rpc-router.md)
)
...
var (
	ENodeType_name = map[int32]string{
		...
		28: "BattleNodeService",
		29: "ClientRpcRouterNodeService",
	}
...
func (ENodeType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_common_base_node_proto_enumTypes[0].Descriptor()
}

func (ENodeType) Type() protoreflect.EnumType {
	return &file_proto_common_base_node_proto_enumTypes[0]
}
...
func (ENodeType) EnumDescriptor() ([]byte, []int) {
	return file_proto_common_base_node_proto_rawDescGZIP(), []int{0}
}
...
func (ESceneNodeType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_common_base_node_proto_enumTypes[1].Descriptor()
}

func (ESceneNodeType) Type() protoreflect.EnumType {
	return &file_proto_common_base_node_proto_enumTypes[1]
}
...
func (ENodeProtocolType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_common_base_node_proto_enumTypes[2].Descriptor()
}

func (ENodeProtocolType) Type() protoreflect.EnumType {
	return &file_proto_common_base_node_proto_enumTypes[2]
}
...
func (ENodeProtocolType) EnumDescriptor() ([]byte, []int) {
	return file_proto_common_base_node_proto_rawDescGZIP(), []int{2}
}

var File_proto_common_base_node_proto protoreflect.FileDescriptor

const file_proto_common_base_node_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/common/base/node.proto\x12\vcommon.base*\x99\x05\n" +
	"\teNodeType\x12\x16\n" +
	...
	"\x11BattleNodeService\x10\x1c\x12\x1e\n" +
	"\x1aClientRpcRouterNodeService\x10\x1d*g\n" +
	...
	"\rPROTOCOL_HTTP\x10\x02B\x13Z\x11proto/common/baseb\x06proto3"

var (
	file_proto_common_base_node_proto_rawDescOnce sync.Once
	file_proto_common_base_node_proto_rawDescData []byte
)

func file_proto_common_base_node_proto_rawDescGZIP() []byte {
	file_proto_common_base_node_proto_rawDescOnce.Do(func() {
		file_proto_common_base_node_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_base_node_proto_rawDesc), len(file_proto_common_base_node_proto_rawDesc)))
	})
	return file_proto_common_base_node_proto_rawDescData
}
...
func init() { file_proto_common_base_node_proto_init() }
func file_proto_common_base_node_proto_init() {
	if File_proto_common_base_node_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_common_base_node_proto_rawDesc), len(file_proto_common_base_node_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_common_base_node_proto_goTypes,
		DependencyIndexes: file_proto_common_base_node_proto_depIdxs,
		EnumInfos:         file_proto_common_base_node_proto_enumTypes,
	}.Build()
	File_proto_common_base_node_proto = out.File
	file_proto_common_base_node_proto_goTypes = nil
	file_proto_common_base_node_proto_depIdxs = nil
}
