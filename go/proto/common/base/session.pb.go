...
func (x *SessionDetails) Reset() {
	*x = SessionDetails{}
	mi := &file_proto_common_base_session_proto_msgTypes[0]
...
func (x *SessionDetails) GetGateNodeId() uint32 {
	if x != nil {
		return x.GateNodeId
	}
	return 0
...
func (x *SessionDetails) GetGateInstanceId() string {
	if x != nil {
...
var (
	...
	file_proto_common_base_session_proto_rawDescData []byte
)

func file_proto_common_base_session_proto_rawDescGZIP() []byte {
	file_proto_common_base_session_proto_rawDescOnce.Do(func() {
		file_proto_common_base_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_base_session_proto_rawDesc), len(file_proto_common_base_session_proto_rawDesc)))
	})
	return file_proto_common_base_session_proto_rawDescData
}

var file_proto_common_base_session_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_common_base_session_proto_goTypes = []any{
	(*SessionDetails)(nil), // 0: SessionDetails
}
var file_proto_common_base_session_proto_depIdxs = []int32{
...
func init() { file_proto_common_base_session_proto_init() }
func file_proto_common_base_session_proto_init() {
	if File_proto_common_base_session_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_common_base_session_proto_rawDesc), len(file_proto_common_base_session_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_common_base_session_proto_goTypes,
		DependencyIndexes: file_proto_common_base_session_proto_depIdxs,
		MessageInfos:      file_proto_common_base_session_proto_msgTypes,
	}.Build()
	File_proto_common_base_session_proto = out.File
	file_proto_common_base_session_proto_goTypes = nil
	file_proto_common_base_session_proto_depIdxs = nil
}
