...
func (x *RegisterPlayerEvent) Reset() {
	*x = RegisterPlayerEvent{}
	mi := &file_proto_common_event_player_event_proto_msgTypes[0]
...
func (*RegisterPlayerEvent) Descriptor() ([]byte, []int) {
	return file_proto_common_event_player_event_proto_rawDescGZIP(), []int{0}
}
...
func (x *PlayerUpgradeEvent) Reset() {
	*x = PlayerUpgradeEvent{}
	mi := &file_proto_common_event_player_event_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PlayerUpgradeEvent) Descriptor() ([]byte, []int) {
	return file_proto_common_event_player_event_proto_rawDescGZIP(), []int{1}
}
...
const file_proto_common_event_player_event_proto_rawDesc = "" +
	"\n" +
	"%proto/common/event/player_event.proto\"8\n" +
	...
	"\renter_gs_type\x18\x02 \x01(\rR\venterGsTypeB\x14Z\x12proto/common/eventb\x06proto3"

var (
	file_proto_common_event_player_event_proto_rawDescOnce sync.Once
	file_proto_common_event_player_event_proto_rawDescData []byte
)

func file_proto_common_event_player_event_proto_rawDescGZIP() []byte {
	file_proto_common_event_player_event_proto_rawDescOnce.Do(func() {
		file_proto_common_event_player_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_event_player_event_proto_rawDesc), len(file_proto_common_event_player_event_proto_rawDesc)))
	})
...
func init() { file_proto_common_event_player_event_proto_init() }
func file_proto_common_event_player_event_proto_init() {
	if File_proto_common_event_player_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_proto_common_event_player_event_proto_goTypes,
		DependencyIndexes: file_proto_common_event_player_event_proto_depIdxs,
		MessageInfos:      file_proto_common_event_player_event_proto_msgTypes,
	}.Build()
	File_proto_common_event_player_event_proto = out.File
	file_proto_common_event_player_event_proto_goTypes = nil
	file_proto_common_event_player_event_proto_depIdxs = nil
}
