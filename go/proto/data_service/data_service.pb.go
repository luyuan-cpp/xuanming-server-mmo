...
type RemapHomeZoneForMergeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SourceZoneId  uint32                 `protobuf:"varint,1,opt,name=source_zone_id,json=sourceZoneId,proto3" json:"source_zone_id,omitempty"`
	TargetZoneId  uint32                 `protobuf:"varint,2,opt,name=target_zone_id,json=targetZoneId,proto3" json:"target_zone_id,omitempty"`
	DryRun        bool                   `protobuf:"varint,3,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"` // if true, only count; no SET
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RemapHomeZoneForMergeRequest) Reset() {
	*x = RemapHomeZoneForMergeRequest{}
	mi := &file_proto_data_service_data_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemapHomeZoneForMergeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemapHomeZoneForMergeRequest) ProtoMessage() {}

func (x *RemapHomeZoneForMergeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_data_service_data_service_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemapHomeZoneForMergeRequest.ProtoReflect.Descriptor instead.
func (*RemapHomeZoneForMergeRequest) Descriptor() ([]byte, []int) {
	return file_proto_data_service_data_service_proto_rawDescGZIP(), []int{13}
}

func (x *RemapHomeZoneForMergeRequest) GetSourceZoneId() uint32 {
	if x != nil {
...
func (x *RemapHomeZoneForMergeRequest) GetTargetZoneId() uint32 {
	if x != nil {
...
func (x *RemapHomeZoneForMergeRequest) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
type RemapHomeZoneForMergeResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ErrorCode      uint32                 `protobuf:"varint,1,opt,name=error_code,json=errorCode,proto3" json:"error_code,omitempty"`
	PlayersMatched uint32                 `protobuf:"varint,2,opt,name=players_matched,json=playersMatched,proto3" json:"players_matched,omitempty"` // home_zone == source_zone_id
	PlayersUpdated uint32                 `protobuf:"varint,3,opt,name=players_updated,json=playersUpdated,proto3" json:"players_updated,omitempty"` // same as matched unless dry_run (then 0)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *RemapHomeZoneForMergeResponse) Reset() {
	*x = RemapHomeZoneForMergeResponse{}
	mi := &file_proto_data_service_data_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemapHomeZoneForMergeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemapHomeZoneForMergeResponse) ProtoMessage() {}

func (x *RemapHomeZoneForMergeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_data_service_data_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemapHomeZoneForMergeResponse.ProtoReflect.Descriptor instead.
func (*RemapHomeZoneForMergeResponse) Descriptor() ([]byte, []int) {
	return file_proto_data_service_data_service_proto_rawDescGZIP(), []int{14}
}

func (x *RemapHomeZoneForMergeResponse) GetErrorCode() uint32 {
	if x != nil {
		return x.ErrorCode
	}
	return 0
...
func (x *RemapHomeZoneForMergeResponse) GetPlayersMatched() uint32 {
	if x != nil {
		return x.PlayersMatched
	}
	return 0
}

func (x *RemapHomeZoneForMergeResponse) GetPlayersUpdated() uint32 {
	if x != nil {
		return x.PlayersUpdated
	}
	return 0
}
...
const file_proto_data_service_data_service_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\rR\x05value:\x028\x01\"\x83\x01\n" +
	"\x1cRemapHomeZoneForMergeRequest\x12$\n" +
	"\x0esource_zone_id\x18\x01 \x01(\rR\fsourceZoneId\x12$\n" +
	"\x0etarget_zone_id\x18\x02 \x01(\rR\ftargetZoneId\x12\x17\n" +
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\"\x90\x01\n" +
	"\x1dRemapHomeZoneForMergeResponse\x12\x1d\n" +
	"\n" +
	"error_code\x18\x01 \x01(\rR\terrorCode\x12'\n" +
	"\x0fplayers_matched\x18\x02 \x01(\rR\x0eplayersMatched\x12'\n" +
	"\x0fplayers_updated\x18\x03 \x01(\rR\x0eplayersUpdated\"f\n" +
	...
	"\x16BatchGetPlayerHomeZone\x12+.data_service.BatchGetPlayerHomeZoneRequest\x1a,.data_service.BatchGetPlayerHomeZoneResponse\"\x00\x12r\n" +
	"\x15RemapHomeZoneForMerge\x12*.data_service.RemapHomeZoneForMergeRequest\x1a+.data_service.RemapHomeZoneForMergeResponse\"\x00\x12c\n" +
