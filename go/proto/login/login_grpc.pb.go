...
func (UnimplementedLoginPreGateServer) AssignGate(context.Context, *AssignGateRequest) (*AssignGateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AssignGate not implemented")
}
func (UnimplementedLoginPreGateServer) QueryQueueStatus(context.Context, *QueryQueueStatusRequest) (*QueryQueueStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryQueueStatus not implemented")
}
...
func RegisterLoginPreGateServer(s grpc.ServiceRegistrar, srv LoginPreGateServer) {
	// If the following call pancis, it indicates UnimplementedLoginPreGateServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedLoginAdminServer) RemovePlayersFromAccounts(context.Context, *RemovePlayersFromAccountsRequest) (*RemovePlayersFromAccountsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemovePlayersFromAccounts not implemented")
}
...
func RegisterLoginAdminServer(s grpc.ServiceRegistrar, srv LoginAdminServer) {
	// If the following call pancis, it indicates UnimplementedLoginAdminServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
