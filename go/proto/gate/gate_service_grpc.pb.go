...
func (UnimplementedGateServer) BroadcastToScene(context.Context, *BroadcastToSceneRequest) (*base.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BroadcastToScene not implemented")
}
...
func (UnimplementedGateServer) GmGracefulShutdown(context.Context, *base.GmGracefulShutdownRequest) (*base.GmGracefulShutdownResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GmGracefulShutdown not implemented")
}
