...
func (x *MissionTableData) GetData() []*MissionTable {
	if x != nil {
		return x.Data
	}
	return nil
...
var (
	...
	file_mission_table_proto_rawDescData []byte
)

func file_mission_table_proto_rawDescGZIP() []byte {
	file_mission_table_proto_rawDescOnce.Do(func() {
		file_mission_table_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mission_table_proto_rawDesc), len(file_mission_table_proto_rawDesc)))
	})
...
var file_mission_table_proto_goTypes = []any{
	...
	(*MissionTableData)(nil), // 1: MissionTableData
}
var file_mission_table_proto_depIdxs = []int32{
	0, // 0: MissionTableData.data:type_name -> MissionTable
...
func file_mission_table_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mission_table_proto_rawDesc), len(file_mission_table_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
