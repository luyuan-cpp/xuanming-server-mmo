...
const (
	...
	MissionError_kMissionTypeAlreadyExists       MissionError = 94
	MissionError_kMissionAlreadyCompleted        MissionError = 95
	MissionError_kMissionIdNotInRewardList       MissionError = 96
	MissionError_kPlayerMissionComponentNotFound MissionError = 97
	MissionError_kMissionIdRepeated              MissionError = 98
	MissionError_kConditionIdOutOfRange          MissionError = 99
	MissionError_kMissionNotInProgress           MissionError = 100
)
...
var (
	MissionError_name = map[int32]string{
		0:   "kMission_errorOK",
		94:  "kMissionTypeAlreadyExists",
		95:  "kMissionAlreadyCompleted",
		96:  "kMissionIdNotInRewardList",
		97:  "kPlayerMissionComponentNotFound",
		98:  "kMissionIdRepeated",
		99:  "kConditionIdOutOfRange",
		100: "kMissionNotInProgress",
	}
...
const file_mission_error_tip_proto_rawDesc = "" +
	"\n" +
	"\x17mission_error_tip.proto*\xf5\x01\n" +
	...
	"\x1fkPlayerMissionComponentNotFound\x10a\x12\x16\n" +
	"\x12kMissionIdRepeated\x10b\x12\x1a\n" +
	"\x16kConditionIdOutOfRange\x10c\x12\x19\n" +
	"\x15kMissionNotInProgress\x10dB\x14Z\x12generated/pb/tableb\x06proto3"
