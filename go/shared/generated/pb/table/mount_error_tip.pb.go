...
const (
	...
	MountError_kMountNotMounted MountError = 11000
)
...
const file_mount_error_tip_proto_rawDesc = "" +
	"\n" +
	"\x15mount_error_tip.proto*8\n" +
	"\vmount_error\x12\x12\n" +
	"\x0ekMount_errorOK\x10\x00\x12\x15\n" +
	"\x10kMountNotMounted\x10\xf8UB$\n" +
