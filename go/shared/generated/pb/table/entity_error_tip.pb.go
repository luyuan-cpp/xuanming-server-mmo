...
const (
	...
	EntityError_kEntityTransformNotFound EntityError = 9000
)
...
const file_entity_error_tip_proto_rawDesc = "" +
	"\n" +
	"\x16entity_error_tip.proto*B\n" +
	"\fentity_error\x12\x13\n" +
	"\x0fkEntity_errorOK\x10\x00\x12\x1d\n" +
	"\x18kEntityTransformNotFound\x10\xa8FB$\n" +
	"\x0ecom.game.tableZ\x12generated/pb/tableb\x06proto3"

var (
	file_entity_error_tip_proto_rawDescOnce sync.Once
	file_entity_error_tip_proto_rawDescData []byte
)

func file_entity_error_tip_proto_rawDescGZIP() []byte {
	file_entity_error_tip_proto_rawDescOnce.Do(func() {
		file_entity_error_tip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_entity_error_tip_proto_rawDesc), len(file_entity_error_tip_proto_rawDesc)))
	})
...
func file_entity_error_tip_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_entity_error_tip_proto_rawDesc), len(file_entity_error_tip_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
