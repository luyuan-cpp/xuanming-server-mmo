...
type ConditionTable struct {
	...
	ConditionCategory uint32                 `protobuf:"varint,2,opt,name=condition_category,json=conditionCategory,proto3" json:"condition_category,omitempty"`
	...
	ValidDuration     uint64                 `protobuf:"varint,7,opt,name=valid_duration,json=validDuration,proto3" json:"valid_duration,omitempty"`
	QuantityType      uint32                 `protobuf:"varint,8,opt,name=quantity_type,json=quantityType,proto3" json:"quantity_type,omitempty"`
	TargetCount       uint32                 `protobuf:"varint,9,opt,name=target_count,json=targetCount,proto3" json:"target_count,omitempty"`
	ComparisonOp      uint32                 `protobuf:"varint,10,opt,name=comparison_op,json=comparisonOp,proto3" json:"comparison_op,omitempty"`
...
func (x *ConditionTable) GetConditionCategory() uint32 {
	if x != nil {
...
func (x *ConditionTable) GetValidDuration() uint64 {
	if x != nil {
...
func (x *ConditionTable) GetQuantityType() uint32 {
	if x != nil {
...
func (x *ConditionTable) GetTargetCount() uint32 {
	if x != nil {
...
func (x *ConditionTable) GetComparisonOp() uint32 {
	if x != nil {
...
const file_condition_table_proto_rawDesc = "" +
	"\n" +
	"\x15condition_table.proto\"\xe3\x02\n" +
	"\x0eConditionTable\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12-\n" +
	"\x12condition_category\x18\x02 \x01(\rR\x11conditionCategory\x12\x1e\n" +
	"\n" +
	...
	"condition4\x12%\n" +
	"\x0evalid_duration\x18\a \x01(\x04R\rvalidDuration\x12#\n" +
	"\rquantity_type\x18\b \x01(\rR\fquantityType\x12!\n" +
	"\ftarget_count\x18\t \x01(\rR\vtargetCount\x12#\n" +
	"\rcomparison_op\x18\n" +
