...
func (UnimplementedSceneSkillClientPlayerServer) NotifySkillUsed(context.Context, *SkillUsedS2C) (*base.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method NotifySkillUsed not implemented")
}
...
func RegisterSceneSkillClientPlayerServer(s grpc.ServiceRegistrar, srv SceneSkillClientPlayerServer) {
	// If the following call panics, it indicates UnimplementedSceneSkillClientPlayerServer was
...
var SceneSkillClientPlayer_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/scene/player_skill.proto",
}
