...
type BaseAttributesComp struct {
	...
	Speed         uint64                 `protobuf:"varint,8,opt,name=speed,proto3" json:"speed,omitempty"`           // 速度:回合制战斗出手序(降序结算),实时战斗暂不消费
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BaseAttributesComp) GetSpeed() uint64 {
	if x != nil {
		return x.Speed
	}
	return 0
...
const file_proto_common_component_actor_comp_proto_rawDesc = "" +
	...
	"\n" +
	"ViewRadius\x12\x16\n" +
	"\x06radius\x18\x01 \x01(\x02R\x06radius\"\xe2\x01\n" +
	...
	"resistance\x12\x14\n" +
	"\x05speed\x18\b \x01(\x04R\x05speed\"!\n" +
	"\tLevelComp\x12\x14\n" +
	...
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01B\x18Z\x16proto/common/componentb\x06proto3"
