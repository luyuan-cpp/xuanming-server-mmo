...
func (x *PlayerSessionSnapshotComp) Reset() {
	*x = PlayerSessionSnapshotComp{}
	mi := &file_proto_common_component_player_network_comp_proto_msgTypes[0]
...
func (*PlayerSessionSnapshotComp) Descriptor() ([]byte, []int) {
	return file_proto_common_component_player_network_comp_proto_rawDescGZIP(), []int{0}
}
...
func (x *PlayerSessionSnapshotComp) GetLastRequestId() string {
	if x != nil {
...
var File_proto_common_component_player_network_comp_proto protoreflect.FileDescriptor

const file_proto_common_component_player_network_comp_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_proto_common_component_player_network_comp_proto_rawDescData []byte
)

func file_proto_common_component_player_network_comp_proto_rawDescGZIP() []byte {
	file_proto_common_component_player_network_comp_proto_rawDescOnce.Do(func() {
		file_proto_common_component_player_network_comp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_common_component_player_network_comp_proto_rawDesc), len(file_proto_common_component_player_network_comp_proto_rawDesc)))
	})
	return file_proto_common_component_player_network_comp_proto_rawDescData
}

var file_proto_common_component_player_network_comp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_common_component_player_network_comp_proto_goTypes = []any{
	(*PlayerSessionSnapshotComp)(nil), // 0: PlayerSessionSnapshotComp
	nil,                               // 1: PlayerSessionSnapshotComp.NodeIdEntry
}
var file_proto_common_component_player_network_comp_proto_depIdxs = []int32{
...
func init() { file_proto_common_component_player_network_comp_proto_init() }
func file_proto_common_component_player_network_comp_proto_init() {
	if File_proto_common_component_player_network_comp_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_common_component_player_network_comp_proto_rawDesc), len(file_proto_common_component_player_network_comp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_common_component_player_network_comp_proto_goTypes,
		DependencyIndexes: file_proto_common_component_player_network_comp_proto_depIdxs,
		MessageInfos:      file_proto_common_component_player_network_comp_proto_msgTypes,
	}.Build()
	File_proto_common_component_player_network_comp_proto = out.File
	file_proto_common_component_player_network_comp_proto_goTypes = nil
	file_proto_common_component_player_network_comp_proto_depIdxs = nil
}
