...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        ...
        {&::_pbi::kDescriptorMethods, &::descriptor_table_rpc_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
namespace muduo {
...
constexpr RpcMessage::ParseTableT_ RpcMessage::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      // .muduo.net.MessageType type = 1;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.type_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
      // fixed64 id = 2;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.id_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kFixed64)},
      // string service = 3;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.service_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // string method = 4;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.method_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // bytes request = 5;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.request_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
      // bytes response = 6;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.response_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
      // .muduo.net.ErrorCode error = 7;
      {PROTOBUF_FIELD_OFFSET(RpcMessage, _impl_.error_), _Internal::kHasBitsOffset + 6, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    }},
    // no aux_entries
    {{
      "\24\0\0\7\6\0\0\0"
...
template <typename>
constexpr RpcMessage::RpcMessage(::_pbi::ConstantInitialized,
...
constexpr auto RpcMessage::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(RpcMessage), alignof(RpcMessage));
}
...
struct RpcMessageGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr RpcMessageGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 RpcMessage_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(RpcMessage::InternalGenerateClassData_(
            _default, &RpcMessage_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<RpcMessage>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~RpcMessageGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) RpcMessage _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<RpcMessage>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(RpcMessageGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST RpcMessageGlobalsTypeInternal RpcMessage_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* RpcMessage_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return RpcMessage_globals_.GetClassData();
#else
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, RpcMessage_get_class_data()) {
...
PROTOBUF_NDEBUG_INLINE RpcMessage::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::muduo::net::RpcMessage& from_msg)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull RpcMessage_class_data_ =
        RpcMessage::InternalGenerateClassData_(RpcMessage_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
RpcMessage::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&RpcMessage_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&RpcMessage_globals_));
  return RpcMessage_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const RpcMessage::ParseTableT_
    RpcMessage::_table_ =
        RpcMessage::InternalGenerateParseTable_(RpcMessage_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
void RpcMessage::MergeImpl(::google::protobuf::MessageLite& to_msg,
