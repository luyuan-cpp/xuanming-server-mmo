...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::taskpb::DBTask
        {&::_pbi::kDescriptorMethods, &::descriptor_table_proto_2fdb_2fdb_5ftask_2eproto, /* tracker*/ nullptr,},
        // ::taskpb::TaskResult
        {&::_pbi::kDescriptorMethods, &::descriptor_table_proto_2fdb_2fdb_5ftask_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
  ...
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::FastBS1,
       {18, 0, 0,
        PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.data_)}},
      // string error = 3;
      {::_pbi::TcParser::FastUS1,
       {26, 1, 0,
        PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.error_)}},
    }}, {{
      65535, 65535
    }}, {{
      // bool success = 1;
      {PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.success_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
      // bytes data = 2;
      {PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.data_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
      // string error = 3;
      {PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.error_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // int64 timestamp = 4;
      {PROTOBUF_FIELD_OFFSET(TaskResult, _impl_.timestamp_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    }},
    // no aux_entries
    {{
      "\21\0\0\5\0\0\0\0"
...
class DBTask::_Internal {
 public:
  using HasBits = decltype(::std::declval<DBTask>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(DBTask, _impl_._has_bits_);
};

constexpr DBTask::ParseTableT_ DBTask::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::FastUS1,
       {18, 0, 0,
        PROTOBUF_FIELD_OFFSET(DBTask, _impl_.where_case_)}},
      // string op = 3;
      {::_pbi::TcParser::FastUS1,
       {26, 1, 0,
        PROTOBUF_FIELD_OFFSET(DBTask, _impl_.op_)}},
      // string msg_type = 4;
      {::_pbi::TcParser::FastUS1,
       {34, 2, 0,
        PROTOBUF_FIELD_OFFSET(DBTask, _impl_.msg_type_)}},
      // bytes body = 5;
      {::_pbi::TcParser::FastBS1,
       {42, 3, 0,
        PROTOBUF_FIELD_OFFSET(DBTask, _impl_.body_)}},
      // string task_id = 6;
      {::_pbi::TcParser::FastUS1,
       {50, 4, 0,
      ...
      // uint64 key = 1;
      {PROTOBUF_FIELD_OFFSET(DBTask, _impl_.key_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
      // string where_case = 2;
      {PROTOBUF_FIELD_OFFSET(DBTask, _impl_.where_case_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // string op = 3;
      {PROTOBUF_FIELD_OFFSET(DBTask, _impl_.op_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // string msg_type = 4;
      {PROTOBUF_FIELD_OFFSET(DBTask, _impl_.msg_type_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // bytes body = 5;
      {PROTOBUF_FIELD_OFFSET(DBTask, _impl_.body_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kBytes | ::_fl::kRepAString)},
      // string task_id = 6;
...
template <typename>
constexpr DBTask::DBTask(::_pbi::ConstantInitialized,
                       const ::_pbi::ClassData* PROTOBUF_NONNULL class_data)
    : ::google::protobuf::Message(
#if defined(PROTOBUF_CUSTOM_VTABLE)
          class_data
...
constexpr auto DBTask::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(DBTask), alignof(DBTask));
}
...
struct DBTaskGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr DBTaskGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 DBTask_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(DBTask::InternalGenerateClassData_(
            _default, &DBTask_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<DBTask>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~DBTaskGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) DBTask _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<DBTask>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(DBTaskGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST DBTaskGlobalsTypeInternal DBTask_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* DBTask_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return DBTask_globals_.GetClassData();
#else
...
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::taskpb::DBTask_globals_,
        &::taskpb::TaskResult_globals_,
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, DBTask_get_class_data()) {
...
PROTOBUF_NDEBUG_INLINE DBTask::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::taskpb::DBTask& from_msg)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull DBTask_class_data_ =
        DBTask::InternalGenerateClassData_(DBTask_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
DBTask::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&DBTask_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&DBTask_globals_));
  return DBTask_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const DBTask::ParseTableT_
    DBTask::_table_ =
        DBTask::InternalGenerateParseTable_(DBTask_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
void DBTask::MergeImpl(::google::protobuf::MessageLite& to_msg,
...
PROTOBUF_NDEBUG_INLINE TaskResult::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::taskpb::TaskResult& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
