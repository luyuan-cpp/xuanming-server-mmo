...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        ...
        {&::_pbi::kDescriptorMethods, &::descriptor_table_proto_2fscene_5fmanager_2fscene_5fnode_5fservice_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
...
class ReleasePlayerRequest::_Internal {
 public:
  using HasBits = decltype(::std::declval<ReleasePlayerRequest>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(ReleasePlayerRequest, _impl_._has_bits_);
};

constexpr ReleasePlayerRequest::ParseTableT_ ReleasePlayerRequest::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::FastUS1,
       {26, 0, 0,
        PROTOBUF_FIELD_OFFSET(ReleasePlayerRequest, _impl_.target_node_id_)}},
    }}, {{
      65535, 65535
    }}, {{
      // uint64 player_id = 1;
      {PROTOBUF_FIELD_OFFSET(ReleasePlayerRequest, _impl_.player_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
      // uint64 target_scene_id = 2;
      {PROTOBUF_FIELD_OFFSET(ReleasePlayerRequest, _impl_.target_scene_id_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
      // string target_node_id = 3;
      {PROTOBUF_FIELD_OFFSET(ReleasePlayerRequest, _impl_.target_node_id_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    }},
    // no aux_entries
    {{
      "\37\0\0\16\0\0\0\0"
...
template <typename>
constexpr ReleasePlayerRequest::ReleasePlayerRequest(::_pbi::ConstantInitialized,
...
constexpr auto ReleasePlayerRequest::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ReleasePlayerRequest), alignof(ReleasePlayerRequest));
}
...
struct ReleasePlayerRequestGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr ReleasePlayerRequestGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 ReleasePlayerRequest_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(ReleasePlayerRequest::InternalGenerateClassData_(
            _default, &ReleasePlayerRequest_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<ReleasePlayerRequest>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~ReleasePlayerRequestGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) ReleasePlayerRequest _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<ReleasePlayerRequest>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(ReleasePlayerRequestGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST ReleasePlayerRequestGlobalsTypeInternal ReleasePlayerRequest_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* ReleasePlayerRequest_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return ReleasePlayerRequest_globals_.GetClassData();
#else
...
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::scene_node::ReleasePlayerRequest_globals_,
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ReleasePlayerRequest_get_class_data()) {
...
PROTOBUF_NDEBUG_INLINE ReleasePlayerRequest::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::scene_node::ReleasePlayerRequest& from_msg)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ReleasePlayerRequest_class_data_ =
        ReleasePlayerRequest::InternalGenerateClassData_(ReleasePlayerRequest_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
ReleasePlayerRequest::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&ReleasePlayerRequest_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&ReleasePlayerRequest_globals_));
  return ReleasePlayerRequest_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ReleasePlayerRequest::ParseTableT_
    ReleasePlayerRequest::_table_ =
        ReleasePlayerRequest::InternalGenerateParseTable_(ReleasePlayerRequest_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
void ReleasePlayerRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
