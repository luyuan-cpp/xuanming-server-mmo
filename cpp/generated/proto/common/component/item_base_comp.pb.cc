...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::ItemComp
        {&::_pbi::kDescriptorMethods, &::descriptor_table_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
class ItemComp::_Internal {
 public:
  using HasBits = decltype(::std::declval<ItemComp>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(ItemComp, _impl_._has_bits_);
};

constexpr ItemComp::ParseTableT_ ItemComp::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(ItemComp, _impl_.acquire_seq_), 3>(),
       {32, 3, 0,
        PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.acquire_seq_)}},
      // uint64 item_id = 1;
      ...
      // uint64 item_id = 1;
      {PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.item_id_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
      // uint32 config_id = 2;
      {PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.config_id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
      // uint32 size = 3;
      {PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.size_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
      // uint64 acquire_seq = 4;
      {PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.acquire_seq_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
    }},
    // no aux_entries
    {{
    }},
...
template <typename>
constexpr ItemComp::ItemComp(::_pbi::ConstantInitialized,
...
constexpr auto ItemComp::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ItemComp), alignof(ItemComp));
}
...
struct ItemCompGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr ItemCompGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 ItemComp_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(ItemComp::InternalGenerateClassData_(
            _default, &ItemComp_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<ItemComp>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~ItemCompGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) ItemComp _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<ItemComp>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(ItemCompGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST ItemCompGlobalsTypeInternal ItemComp_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* ItemComp_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return ItemComp_globals_.GetClassData();
#else
...
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto = nullptr;
const ::uint32_t
...
const char descriptor_table_protodef_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "nfig_id\030\002 \001(\r\022\014\n\004size\030\003 \001(\r\022\023\n\013acquire_s"
    "eq\030\004 \001(\004B\022Z\020common/componentb\006proto3"
};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto = {
    ...
    schemas,
    file_message_globals,
    TableStruct_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto::offsets,
    file_level_enum_descriptors_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto,
    file_level_service_descriptors_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto,
};
// ===================================================================

ItemComp::ItemComp(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, ItemComp_get_class_data()) {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull ItemComp_class_data_ =
        ItemComp::InternalGenerateClassData_(ItemComp_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
ItemComp::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&ItemComp_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&ItemComp_globals_));
  return ItemComp_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ItemComp::ParseTableT_
    ItemComp::_table_ =
        ItemComp::InternalGenerateParseTable_(ItemComp_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
// @@protoc_insertion_point(message_clear_start:ItemComp)
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x0000000fU)) {
    ::memset(&_impl_.item_id_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.item_id_)) + sizeof(_impl_.acquire_seq_));
  }
...
::uint8_t* PROTOBUF_NONNULL ItemComp::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000008U)) {
    if (this_._internal_acquire_seq() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
          4, this_._internal_acquire_seq(), target);
    }
  }
...
void ItemComp::MergeImpl(::google::protobuf::MessageLite& to_msg,
...
void ItemComp::InternalSwap(ItemComp* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.acquire_seq_)
      + sizeof(ItemComp::_impl_.acquire_seq_)
      - PROTOBUF_FIELD_OFFSET(ItemComp, _impl_.item_id_)>(
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_proto_2fcommon_2fcomponent_2fitem_5fbase_5fcomp_2eproto),
         ::std::false_type{});
