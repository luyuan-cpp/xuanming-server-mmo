...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::PlayerSceneInfoComp
        {&::_pbi::kDescriptorMethods, &::descriptor_table_proto_2fcommon_2fcomponent_2fplayer_5fscene_5fcomp_2eproto, /* tracker*/ nullptr,},
...
class PlayerSceneInfoComp::_Internal {
 public:
  using HasBits = decltype(::std::declval<PlayerSceneInfoComp>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(PlayerSceneInfoComp, _impl_._has_bits_);
};

constexpr PlayerSceneInfoComp::ParseTableT_ PlayerSceneInfoComp::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      // uint32 scene_config_id = 1;
      {PROTOBUF_FIELD_OFFSET(PlayerSceneInfoComp, _impl_.scene_config_id_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
      // uint32 guid = 2;
      {PROTOBUF_FIELD_OFFSET(PlayerSceneInfoComp, _impl_.guid_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    }},
    // no aux_entries
    {{
    }},
...
template <typename>
constexpr PlayerSceneInfoComp::PlayerSceneInfoComp(::_pbi::ConstantInitialized,
...
constexpr auto PlayerSceneInfoComp::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(PlayerSceneInfoComp), alignof(PlayerSceneInfoComp));
}
...
struct PlayerSceneInfoCompGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr PlayerSceneInfoCompGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 PlayerSceneInfoComp_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(PlayerSceneInfoComp::InternalGenerateClassData_(
            _default, &PlayerSceneInfoComp_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<PlayerSceneInfoComp>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~PlayerSceneInfoCompGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) PlayerSceneInfoComp _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<PlayerSceneInfoComp>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(PlayerSceneInfoCompGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST PlayerSceneInfoCompGlobalsTypeInternal PlayerSceneInfoComp_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* PlayerSceneInfoComp_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return PlayerSceneInfoComp_globals_.GetClassData();
#else
...
class PlayerSceneContextComp::_Internal {
 public:
  using HasBits = decltype(::std::declval<PlayerSceneContextComp>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
      8 * PROTOBUF_FIELD_OFFSET(PlayerSceneContextComp, _impl_._has_bits_);
};

constexpr PlayerSceneContextComp::ParseTableT_ PlayerSceneContextComp::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      // .PlayerSceneInfoComp scene_info = 1;
      {PROTOBUF_FIELD_OFFSET(PlayerSceneContextComp, _impl_.scene_info_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
      // .PlayerSceneInfoComp scene_info_last_time = 2;
      {PROTOBUF_FIELD_OFFSET(PlayerSceneContextComp, _impl_.scene_info_last_time_), _Internal::kHasBitsOffset + 1, 1, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    }},
    {{
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::PlayerSceneInfoComp>()},
        #else
        {::_pbi::FieldAuxMessageGlobals(), &::PlayerSceneInfoComp_globals_},
        #endif
        #ifndef PROTOBUF_MESSAGE_GLOBALS
        {::_pbi::TcParser::GetTable<::PlayerSceneInfoComp>()},
        #else
...
template <typename>
constexpr PlayerSceneContextComp::PlayerSceneContextComp(::_pbi::ConstantInitialized,
                       const ::_pbi::ClassData* PROTOBUF_NONNULL class_data)
    : ::google::protobuf::Message(
#if defined(PROTOBUF_CUSTOM_VTABLE)
          class_data
...
constexpr auto PlayerSceneContextComp::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(PlayerSceneContextComp), alignof(PlayerSceneContextComp));
}
...
struct PlayerSceneContextCompGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr PlayerSceneContextCompGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 PlayerSceneContextComp_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(PlayerSceneContextComp::InternalGenerateClassData_(
            _default, &PlayerSceneContextComp_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<PlayerSceneContextComp>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~PlayerSceneContextCompGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) PlayerSceneContextComp _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<PlayerSceneContextComp>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(PlayerSceneContextCompGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST PlayerSceneContextCompGlobalsTypeInternal PlayerSceneContextComp_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* PlayerSceneContextComp_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return PlayerSceneContextComp_globals_.GetClassData();
#else
...
static const ::_pbi::MessageGlobalsBase* PROTOBUF_NONNULL const
    file_message_globals[] = {
        &::PlayerSceneInfoComp_globals_,
        &::PlayerSceneContextComp_globals_,
};
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, PlayerSceneInfoComp_get_class_data()) {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PlayerSceneInfoComp_class_data_ =
        PlayerSceneInfoComp::InternalGenerateClassData_(PlayerSceneInfoComp_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
PlayerSceneInfoComp::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&PlayerSceneInfoComp_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&PlayerSceneInfoComp_globals_));
  return PlayerSceneInfoComp_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const PlayerSceneInfoComp::ParseTableT_
    PlayerSceneInfoComp::_table_ =
        PlayerSceneInfoComp::InternalGenerateParseTable_(PlayerSceneInfoComp_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
void PlayerSceneInfoComp::MergeImpl(::google::protobuf::MessageLite& to_msg,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, PlayerSceneContextComp_get_class_data()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE PlayerSceneContextComp::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::PlayerSceneContextComp& from_msg)
...
PlayerSceneContextComp::PlayerSceneContextComp(
  ...
  _impl_.scene_info_ = (CheckHasBit(cached_has_bits, 0x00000001U))
                ...
                : nullptr;
  _impl_.scene_info_last_time_ = (CheckHasBit(cached_has_bits, 0x00000002U))
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull PlayerSceneContextComp_class_data_ =
        PlayerSceneContextComp::InternalGenerateClassData_(PlayerSceneContextComp_globals_._default);
...
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
PlayerSceneContextComp::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&PlayerSceneContextComp_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&PlayerSceneContextComp_globals_));
  return PlayerSceneContextComp_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const PlayerSceneContextComp::ParseTableT_
    PlayerSceneContextComp::_table_ =
        PlayerSceneContextComp::InternalGenerateParseTable_(PlayerSceneContextComp_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
...
void PlayerSceneContextComp::MergeImpl(::google::protobuf::MessageLite& to_msg,
                      const ::google::protobuf::MessageLite& from_msg) {
