...
template <typename T>
[[nodiscard]] const ::std::string& eNodeType_Name(T value) {
...
[[nodiscard]] inline bool eSceneNodeType_IsValid(int value) {
  return 0 <= value && value <= 3;
}
inline constexpr int eSceneNodeType_ARRAYSIZE = 3 + 1;
[[nodiscard]] const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL
eSceneNodeType_descriptor();
[[nodiscard]] inline auto ProtobufInternalGetEnumDescriptor(eSceneNodeType) {
  return eSceneNodeType_descriptor();
}
template <typename T>
[[nodiscard]] const ::std::string& eSceneNodeType_Name(T value) {
...
template <>
[[nodiscard]] inline const ::std::string& eSceneNodeType_Name(eSceneNodeType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<eSceneNodeType_descriptor, 0, 3>(
      static_cast<int>(value));
}
[[nodiscard]] inline bool eSceneNodeType_Parse(
...
[[nodiscard]] inline bool eNodeProtocolType_IsValid(int value) {
  return 0 <= value && value <= 2;
}
inline constexpr int eNodeProtocolType_ARRAYSIZE = 2 + 1;
[[nodiscard]] const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL
eNodeProtocolType_descriptor();
[[nodiscard]] inline auto ProtobufInternalGetEnumDescriptor(eNodeProtocolType) {
  return eNodeProtocolType_descriptor();
}
template <typename T>
[[nodiscard]] const ::std::string& eNodeProtocolType_Name(T value) {
...
template <>
[[nodiscard]] inline const ::std::string& eNodeProtocolType_Name(eNodeProtocolType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<eNodeProtocolType_descriptor, 0, 2>(
      static_cast<int>(value));
}
[[nodiscard]] inline bool eNodeProtocolType_Parse(
