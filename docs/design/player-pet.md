...
- **`AttributeDimension` 新增 401-404**:宝宝的体质 / 灵力 / 力量 / 敏捷,系数比角色低一档。
  ...
  (原 25 + 1.5 / 15 + 2.5 / 4 / 2.5;角色当时为 50 + 5 / 10 + 40 / 50 / 3,换算规则见 `player-attribute-allocation.md` §2.2)。
  2026-09-14 速度单位 ×12(与角色同步):敏捷 2.5 → 30 速度,`Pet.init_speed` 12 / 6 / 9 / 10 → 144 / 72 / 108 / 120。
  同日防御 ×12 / 法力 ×4(与角色同步):体质 3.75 → 45 防、灵力 7.5 → 30 蓝,`Pet.init_mana` 200 / 80 / 100 / 300 → 800 / 320 / 400 / 1200;
  存档里宝宝的当前法力随主人一起迁移 ×4(`player-attribute-allocation.md` §5)。
