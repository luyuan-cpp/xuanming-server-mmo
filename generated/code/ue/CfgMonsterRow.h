...
//    generated/tables/monster.json 不是 protojson,是导表器自己 json.dumps 出来的,
...
/// 这个代价不再是静默的:MonsterTable.cpp 在装载路径上对**由无符号收窄而来**的列
/// 做值域检查,越界会打 Error 并点名表/行/列。
USTRUCT(BlueprintType)
struct FCfgMonsterRow : public FTableRowBase
{
	GENERATED_BODY()
