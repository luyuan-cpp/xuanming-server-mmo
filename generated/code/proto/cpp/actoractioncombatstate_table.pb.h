...
#ifndef actoractioncombatstate_5ftable_2eproto_2epb_2eh
#define actoractioncombatstate_5ftable_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_actoractioncombatstate_5ftable_2eproto;
}  // extern "C"
class ActorActionCombatStateTable;
struct ActorActionCombatStateTableGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern ActorActionCombatStateTableGlobalsTypeInternal ActorActionCombatStateTable_globals_;
extern const ::google::protobuf::internal::ClassDataFull ActorActionCombatStateTable_class_data_;
#else
extern const ActorActionCombatStateTableGlobalsTypeInternal ActorActionCombatStateTable_globals_;
#endif  // PROTOBUF_MESSAGE_GLOBALS
class ActorActionCombatStateTableData;
struct ActorActionCombatStateTableDataGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern ActorActionCombatStateTableDataGlobalsTypeInternal ActorActionCombatStateTableData_globals_;
extern const ::google::protobuf::internal::ClassDataFull ActorActionCombatStateTableData_class_data_;
#else
extern const ActorActionCombatStateTableDataGlobalsTypeInternal ActorActionCombatStateTableData_globals_;
#endif  // PROTOBUF_MESSAGE_GLOBALS
class ActorActionCombatStatestate;
struct ActorActionCombatStatestateGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern ActorActionCombatStatestateGlobalsTypeInternal ActorActionCombatStatestate_globals_;
extern const ::google::protobuf::internal::ClassDataFull ActorActionCombatStatestate_class_data_;
#else
extern const ActorActionCombatStatestateGlobalsTypeInternal ActorActionCombatStatestate_globals_;
#endif  // PROTOBUF_MESSAGE_GLOBALS
namespace google {
namespace protobuf {
}  // namespace protobuf
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ActorActionCombatStatestate final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:ActorActionCombatStatestate) */ {
 public:
  ...
  explicit constexpr ActorActionCombatStatestate(::google::protobuf::internal::ConstantInitialized,
  ...
  inline ActorActionCombatStatestate(ActorActionCombatStatestate&& from) noexcept : ActorActionCombatStatestate(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const ActorActionCombatStatestate& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<ActorActionCombatStatestate>(&ActorActionCombatStatestate_globals_);
  }
  ...
  [[nodiscard]] ActorActionCombatStatestate* PROTOBUF_NONNULL
 ...
 public:
  ...
  [[nodiscard]] ::uint32_t state_mode() const;
  ...
  [[nodiscard]] ::uint32_t state_tip() const;
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ActorActionCombatStateTable final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:ActorActionCombatStateTable) */ {
 public:
  ...
  template <typename = void>
  explicit constexpr ActorActionCombatStateTable(::google::protobuf::internal::ConstantInitialized,
                           const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
                               class_data);

  inline ActorActionCombatStateTable(const ActorActionCombatStateTable& from) : ActorActionCombatStateTable(nullptr, from) {}
  inline ActorActionCombatStateTable(ActorActionCombatStateTable&& from) noexcept : ActorActionCombatStateTable(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const ActorActionCombatStateTable& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<ActorActionCombatStateTable>(&ActorActionCombatStateTable_globals_);
  }
  ...
  [[nodiscard]] ActorActionCombatStateTable* PROTOBUF_NONNULL
  New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
 ...
 public:
  ...
  public:
  void clear_state() ;
  [[nodiscard]] const ::ActorActionCombatStatestate& state(int index) const;
  [[nodiscard]] ::ActorActionCombatStatestate* PROTOBUF_NONNULL mutable_state(int index);
  ::ActorActionCombatStatestate* PROTOBUF_NONNULL add_state();
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::ActorActionCombatStatestate>&
  state() const;
  [[nodiscard]] ::google::protobuf::RepeatedPtrField<::ActorActionCombatStatestate>* PROTOBUF_NONNULL
  mutable_state();
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ActorActionCombatStateTableData final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:ActorActionCombatStateTableData) */ {
 public:
  inline ActorActionCombatStateTableData() : ActorActionCombatStateTableData(nullptr) {}
  ~ActorActionCombatStateTableData() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ActorActionCombatStateTableData* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(ActorActionCombatStateTableData));
  }
#endif

  template <typename = void>
  explicit constexpr ActorActionCombatStateTableData(::google::protobuf::internal::ConstantInitialized,
                           const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
                               class_data);

  inline ActorActionCombatStateTableData(const ActorActionCombatStateTableData& from) : ActorActionCombatStateTableData(nullptr, from) {}
  inline ActorActionCombatStateTableData(ActorActionCombatStateTableData&& from) noexcept : ActorActionCombatStateTableData(nullptr, ::std::move(from)) {}
  inline ActorActionCombatStateTableData& operator=(const ActorActionCombatStateTableData& from) {
    CopyFrom(from);
    return *this;
  }
  inline ActorActionCombatStateTableData& operator=(ActorActionCombatStateTableData&& from) noexcept {
    if (this == &from) return *this;
    if (::google::protobuf::internal::CanMoveWithInternalSwap(GetArena(), from.GetArena())) {
      InternalSwap(&from);
    } else {
  ...
  [[nodiscard]] static const ActorActionCombatStateTableData& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<ActorActionCombatStateTableData>(&ActorActionCombatStateTableData_globals_);
  }
  static constexpr int kIndexInFileMessages = 2;
  friend void swap(ActorActionCombatStateTableData& a, ActorActionCombatStateTableData& b) { a.Swap(&b); }
  inline void Swap(ActorActionCombatStateTableData* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ActorActionCombatStateTableData* PROTOBUF_NONNULL other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  [[nodiscard]] ActorActionCombatStateTableData* PROTOBUF_NONNULL
  New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<ActorActionCombatStateTableData>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const ActorActionCombatStateTableData& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const ActorActionCombatStateTableData& from) { ActorActionCombatStateTableData::MergeImpl(*this, from); }
  ...
  void SharedCtor(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(ActorActionCombatStateTableData* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "ActorActionCombatStateTableData"; }

  explicit ActorActionCombatStateTableData(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  ActorActionCombatStateTableData(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const ActorActionCombatStateTableData& from);
  ActorActionCombatStateTableData(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, ActorActionCombatStateTableData&& from) noexcept
      : ActorActionCombatStateTableData(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL GetClassData() const PROTOBUF_FINAL;
  static void* PROTOBUF_NONNULL PlacementNew_(
 ...
 public:
  ...
  public:
  void clear_data() ;
  [[nodiscard]] const ::ActorActionCombatStateTable& data(int index) const;
  [[nodiscard]] ::ActorActionCombatStateTable* PROTOBUF_NONNULL mutable_data(int index);
  ::ActorActionCombatStateTable* PROTOBUF_NONNULL add_data();
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>&
  data() const;
  [[nodiscard]] ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>* PROTOBUF_NONNULL
  mutable_data();
...
inline ::ActorActionCombatStatestate* PROTOBUF_NONNULL ActorActionCombatStateTable::add_state()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::ActorActionCombatStatestate* _add =
...
ActorActionCombatStateTable::mutable_state() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
...
// repeated .ActorActionCombatStateTable data = 1;
inline int ActorActionCombatStateTableData::_internal_data_size() const {
  return _internal_data().size();
}
inline int ActorActionCombatStateTableData::data_size() const {
  return _internal_data_size();
}
inline void ActorActionCombatStateTableData::clear_data() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.data_.Clear();
  ClearHasBit(_impl_._has_bits_[0], 0x00000001U);
}
inline const ::ActorActionCombatStateTable& ActorActionCombatStateTableData::data(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:ActorActionCombatStateTableData.data)
  return _internal_data().Get(index);
}
inline ::ActorActionCombatStateTable* PROTOBUF_NONNULL ActorActionCombatStateTableData::mutable_data(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:ActorActionCombatStateTableData.data)
  return _internal_mutable_data()->Mutable(index);
}
inline ::ActorActionCombatStateTable* PROTOBUF_NONNULL ActorActionCombatStateTableData::add_data()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::ActorActionCombatStateTable* _add =
      _internal_mutable_data()->InternalAddWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), GetArena());
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_add:ActorActionCombatStateTableData.data)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>& ActorActionCombatStateTableData::data() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:ActorActionCombatStateTableData.data)
  return _internal_data();
}
inline ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>* PROTOBUF_NONNULL
ActorActionCombatStateTableData::mutable_data() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_mutable_list:ActorActionCombatStateTableData.data)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_data();
}
inline const ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>&
ActorActionCombatStateTableData::_internal_data() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.data_;
}
inline ::google::protobuf::RepeatedPtrField<::ActorActionCombatStateTable>* PROTOBUF_NONNULL
ActorActionCombatStateTableData::_internal_mutable_data() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.data_;
}
...
#endif  // actoractioncombatstate_5ftable_2eproto_2epb_2eh
