...
#ifndef tip_2fmission_5ferror_5ftip_2eproto_2epb_2eh
#define tip_2fmission_5ferror_5ftip_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_tip_2fmission_5ferror_5ftip_2eproto
...
struct TableStruct_tip_2fmission_5ferror_5ftip_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_tip_2fmission_5ferror_5ftip_2eproto;
}  // extern "C"
...
namespace protobuf {
template <>
internal::EnumTraitsT<::mission_error_internal_data_>
    internal::EnumTraitsImpl::value<::mission_error>;
}  // namespace protobuf
}  // namespace google
...
template <typename T>
[[nodiscard]] const ::std::string& mission_error_Name(T value) {
...
[[nodiscard]] inline bool mission_error_Parse(
    ::absl::string_view name, mission_error* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<mission_error>(mission_error_descriptor(), name,
                                           value);
}
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::mission_error>() {
  return ::mission_error_descriptor();
}
...
#endif  // tip_2fmission_5ferror_5ftip_2eproto_2epb_2eh
