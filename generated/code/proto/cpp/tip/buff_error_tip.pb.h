...
#ifndef tip_2fbuff_5ferror_5ftip_2eproto_2epb_2eh
#define tip_2fbuff_5ferror_5ftip_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_tip_2fbuff_5ferror_5ftip_2eproto
...
struct TableStruct_tip_2fbuff_5ferror_5ftip_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_tip_2fbuff_5ferror_5ftip_2eproto;
}  // extern "C"
enum buff_error : int;
...
namespace protobuf {
template <>
internal::EnumTraitsT<::buff_error_internal_data_>
    internal::EnumTraitsImpl::value<::buff_error>;
}  // namespace protobuf
}  // namespace google
...
template <typename T>
[[nodiscard]] const ::std::string& buff_error_Name(T value) {
...
[[nodiscard]] inline bool buff_error_Parse(
    ::absl::string_view name, buff_error* PROTOBUF_NONNULL value) {
  return ::google::protobuf::internal::ParseNamedEnum<buff_error>(buff_error_descriptor(), name,
                                           value);
}
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::buff_error>() {
  return ::buff_error_descriptor();
}
...
#endif  // tip_2fbuff_5ferror_5ftip_2eproto_2epb_2eh
